...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
What is negative infinity? (-1/0) = -Infinity
...
What is the diffrence between Increment ++ and Decrement -- operator using before and after the variable 
...
The for…in loop is used to loop through an object’s properties and array’s elements.

var extraProp = { name:'Pranay', lastname:'Rathor'}
...
mainProperties.prototype = extraProp;
var obj = new mainProperties()

for (var prop in obj){
    console.log(prop +":"+extraProp.value );
...
means basically var defined the variable globally so u can access from anywhere apart let is only block scoped .
...
----------------------------------------------------------------------------------------------------------------------------------------------------
 Explain hoisting and scopping in JavaScript?
****Scoping 
